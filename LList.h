 ...
 */
extern void ListAppend(LList* pList, void* pData);
/**
 * @brief 提取表中元素并释放结点空间
 * @param pList 链表list
 ...
 * @return 删除的元素数据项指针
 */
extern void* ListRemove(LList* pList, size_t index);
/**
 ...
 */
extern size_t ListFindMin(LList list, char(*compareCallback)(void*, void*));